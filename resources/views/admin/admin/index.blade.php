    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href="{{url('/admin/home')}}">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem fa fa-edit" href="{{url('/material/create')}}">&nbsp;&nbsp;素材添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem fa fa-table" href="{{url('/material/index')}}">&nbsp;&nbsp;素材展示</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem fa fa-edit" href="{{url('/news/create')}}">&nbsp;&nbsp;新闻添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem fa fa-table" href="{{url('/news/index')}}">&nbsp;&nbsp;新闻展示</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem fa fa-edit" href="{{url('/channel/create')}}">&nbsp;&nbsp;渠道添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem fa fa-table" href="{{url('/channel/index')}}">&nbsp;&nbsp;渠道展示</a>
                        </li>
                        <li>
                            <a class="J_menuItem fa fa-magic" href="{{url('/channel/statistical')}}">&nbsp;&nbsp;渠道统计图表</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem fa fa-edit" href="{{url('/channel/create')}}">&nbsp;&nbsp;菜单添加</a>
                        </li>
                        <li>
                            <a class="J_menuItem fa fa-table" href="{{url('/channel/index')}}">&nbsp;&nbsp;菜单展示</a>
                        </li>
                    </ul>
                </li>
                <li class="line dk"></li>
